...
-------------------------------------------ITEM----------------------------------------------
AddList("models/weapons/w_defuser.mdl", "Набор отмычек", "Одноразовый набор дверных отмычек.\n+ 70% к скорости взлома", "buy_disposable_masterkey", "1000")
AddList("models/Items/battery.mdl", "Батарейка", "Одноразовая батарейка.\nСлужит источником питания фонарика,\nа также служит источником питания некоторых электроприборов.\nТребуеться для крафта некоторых вещей.", "buy_battarey", "250")
//AddList("spawnicons/models/attachments/cmore.png", "Кобра", "Стандартный прицел стоит на вооружении сил России.\nОбеспечивает небольшое увеличение", "buy_kobra")
//AddList("spawnicons/models/attachments/aimpoint.png", "Aimpoint", "Голографический прицел, стоит на вооружении США.\nОбспечивает среднее увелечение", "buy_aimpoint")
//AddList("spawnicons/models/attachments/ballistic.png", "Баллистический прицел 12x", "Съемный баллистический прицел.\nИспользуеться только при стрельбе на очень большие дистанции", "buy_ballistic")
...
usermessage.Hook("ShopNpcItemUsed", SpawnItem)