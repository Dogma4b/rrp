...
AddList("models/player/Group01/Male_09.mdl", "Горожанин", "citizen", "Вы самый обычный человек в этом городе.\nНайдите себе работу, купите квартиру, обустройте её.\nВы не имеете особой роли в жизни города.")
...
usermessage.Hook("jobs_legalUSE", jobs_legal) 